...
**Static Analysis**
Static analysis involves examining the binary without executing it.
...
- [System calls](https://syscalls.w3challs.com) are identified by numbers that vary across platforms:
